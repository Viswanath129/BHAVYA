...
class EEVTemporalModel(nn.Module):
    ...
    def predict_from_vector(self, base_vector, seq_len=30):
        """
        End-to-end inference from a single emotion vector.
        1. Simulates temporal persistence (30 steps).
        2. Performs LSTM forward pass.
        3. Returns pattern label and risk score.
        """
