...
async def analyze_questions(data: QuestionInput):
    ...
    2. Centralized Temporal Model Inference
    """
    try:
        ...
        sequence_np = analysis_results["sequence"]
        
        return {
            "pattern": analysis_results["pattern"],
        ...
        logger.error(f"Error in analyze_questions: {str(e)}", exc_info=True)
